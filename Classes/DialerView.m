...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (compositeDescription.extension != nil && ![compositeDescription.extension isEqualToString:@""]) {
        [_addressField setText:compositeDescription.extension];
        compositeDescription.extension = @"";
    } else {
