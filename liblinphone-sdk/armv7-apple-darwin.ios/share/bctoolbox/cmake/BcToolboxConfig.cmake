...
foreach(comp ${BcToolbox_FIND_COMPONENTS})
	...
	if(TARGET ${targetname})
		...
		if(LINPHONE_BUILDER_GROUP_EXTERNAL_SOURCE_PATH_BUILDERS)
			...
			list(INSERT BCTOOLBOX_${uppercomp}_INCLUDE_DIRS 0 "/Users/cleisonmelo/Desktop/repository/linphone-iphone-master/linphone-iphone/liblinphone-sdk/armv7-apple-darwin.ios/include")
		endif()
